...
def main(argv):
    ...
    n_components_shape = float(args.n_components_shape)
    if n_components_shape >= 1: n_components_shape = int(n_components_shape)
    n_components_texture = float(args.n_components_texture)
    if n_components_texture >= 1: n_components_texture = int(n_components_texture)
