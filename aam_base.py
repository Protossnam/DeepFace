...
#        for shape in self:
#            img = shape.loadImg()
#            tform_global = skimage.transform.estimate_transform('affine', src=s0, dst=shape.points)
#            tform_piecewise = skimage.transform.estimate_transform('piecewise-affine', src=s0, dst=tform_global.inverse(shape.points))
#            self._warpImageToA0(src=img, dst=aligned_texture.data, W=tform_piecewise, N=tform_global, accelerate=False)
...
#        s0 = self.pcaShapeGetS(0, map_to_a0=True)
